package br.com.fiap.buslineapp.ui.signup
...
import br.com.fiap.buslineapp.ui.model.User
...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveInRealTimeDatabase() {
        var user =
            User(inputName.text.toString(), inputEmail.text.toString(), inputPhone.text.toString())
